...
public static class LocaleService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
    {
        ["en-US"] = new()
        {
            ...
            ["blockedPartial"] = "Blocked '{0}': {1} success, {2} failed.",
            ...
            ["modeCustom"] = "Custom IP/CIDR",
            ["customModeNote"] = "Note: due to Windows Firewall limitations, outbound traffic to non-allowed addresses is not blocked. Only inbound blocking is enforced.",
        ...
        ["zh-CN"] = new()
        {
            ...
            ["blockedPartial"] = "已禁止 '{0}'：成功 {1} 条，失败 {2} 条。",
            ...
            ["modeAllowAll"] = "允许全部",
            ["modeLanOnly"] = "仅局域网",
            ["modeCustom"] = "指定 IP/CIDR",
            ["customModeNote"] = "注意：受 Windows 防火墙限制，出站流量无法阻断非允许地址，仅入站阻断生效。",
            ["applyMode"] = "应用模式",
